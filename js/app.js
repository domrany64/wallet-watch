...
function renderTransactions() {
    ...
    mainContent.innerHTML = `
        ...
        <div class="filter-bar">
            <input type="text" id="filterSearch" placeholder="Search description..." value="" autocomplete="new-password" onkeyup="window._searchDebounce()" style="padding:0.4rem 0.6rem;background:var(--surface);border:1px solid var(--border);border-radius:6px;color:var(--text);font-size:0.8rem;font-family:var(--font);min-width:160px">
...
window._searchDebounce = () => {
    clearTimeout(_searchTimer);
    _searchTimer = setTimeout(() => window._applyTxnFilter(), 600);
};
